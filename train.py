...
from init import cleanup, init_wandb, open_log, set_seed
from model import GPT, GPTConfig
from utils import (dotdict, get_cosine_warmp_lr, get_dataloader,
                   get_dataloader_lol)
...
def main(cfg):
    ...
    # Create dataloaders
    train_dataloader, val_dataloader = get_dataloader_lol(
        train_data_path=data_dir_train,
        val_data_path=data_dir_eval,
        ...
        if iter_num % cfg.eval_interval == 0 and master_process:
            ...
            if losses["val"] < best_val_loss or cfg.always_save_checkpoint:
                ...
                if iter_num > 0 and iter_num % (cfg.save_ckpt_interval) == 0:
                    ...
                    torch.save(
                        checkpoint,
                        os.path.join(cfg.out_dir, "ckpt" + str(iter_num) + ".pt"),
                    )
